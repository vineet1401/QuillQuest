        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <div className="mt-4 flex flex-col justify-between">
            ...
            <input
              ...
              onChange={(e) => handleEditChange(e)}
            />
            <Link className="text-xs text-gray-500 hover:text-gray-900 text-end w-full mt-2">
              Forget Password?
            </Link>
          </div>
          <div className="mt-8">
          ...
          <Link className=" flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
